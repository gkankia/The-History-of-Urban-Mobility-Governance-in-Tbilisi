...
const events = [
  ...
  { date: "2004-01-05", title: "თბილისი - საცობიანი ქუჩების ქალაქი", 
    ...
    category: "article", image: '/Users/giorgikankia/Documents/GitHub/The-History-of-Urban-Mobility-Governance-in-Tbilisi/img/კვირის პალიტრა -3 2004.png', 
    source: {
  ...
  { date: "2004-01-11", title: "მეტროპოლიტენის მუშაკთა დღე", 
    ...
    პოსტსაბჭოთა ტრანზიციის წლები მეტროზეც აისახა. ურბანული მობილობის გარდა, პოლიტიკურ-ეკონომიკური კრიზისების კვალდაკვალ, მეტროს ინფრასტრუქტურამ დამსაქმებლის 
  ...
  { date: "2004-01-19", title: "ინტერვიუ ვანო ზოდელავასთან", 
    description: `თბილისის მაშინდელი მერი ქალაქის გამოწვევად <strong>250 მლნ ლარით გარღვეული მუნიციპალური ბიუჯეტის კვალდაკვალ,</strong> ენერგეტიკულ და სატრანსპორტო პრობლემებსაც მიიჩნევდა და არაერთი ახალი ობიექტის მშენებლობის დაპირებას იძლეოდა: <blockquote>უპირველესად, მეტროსადგურ 'უნივერსიტეტის' მშენებლობას ვგულისხმობ [...] სამარშრუტო ტაქსების რაოდენობა შემცირდება, გაიხსნება რუსთაველის გამზირის პარალელური ძნელაძის ქუჩა, დიდუბის რაიონში ესტაკადის მშენებლობის დაწყებას ვაპირებთ.</blockquote>`, 
