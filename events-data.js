...
const events = [
  ...
  { date: "2004-01-04", title: "სიცოცხლის გზაჯვარედინზე", 
    ...
    category: "article", 
    source: {
      name: "საქართველოს რესპუბლიკა #2 (4732), 2004",
  ...
  { date: "2004-01-04", title: "საპრეზიდენტო არჩევნები", 
    ...
    როგორც მისი პრეზიდენტობის მომდევნო წლებში გამოჩნდა, სააკაშვილის მმართველობამ და პირადად მან, დიდი ზეგავლენა იქონია საქართველოს ქალაქების განვითარებისა 
    და <strong>[ურბანული] მობილობის</strong> მართვის კუთხით. 
    რევოლუციის ერთ-ერთ თვალსაჩინო სიმბოლოდ,  <a class="in_text_source" href="https://www.youtube.com/embed/RW-Rfapzim0?si=HpAjBJ3dQt6UfNCL" target="_blank">საქალაქთაშორისო ავტობუსით,</a> მხარდამჭერებთან ერთად, წალენჯიხიდან თბილისში ჩამოსული მიხეილ სააკაშვილის ეს კადრებიც იქცა.`, 
    category: "event",
    source: {
