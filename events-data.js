...
const events = [
  ...
  { date: "2004-01-23", title: "ძალაუფლების განაწილება მიწის ქვეშ", 
    ...
    როგორც, ჟურნალისტი სოფო თოდუა, თავის სტატიაში მოიხსენიებს, მეტროს "ყოველდღიური ბინადრები" ებმებოდნენ არაფორმალური და კორუფციული გარიგებების სრულ ჯაჭვში - 
    მეტროში, საღამოს 7 საათამდე, ვაჭრობის ოფიციალურად აკრძალვის მიუხედავად, ხელზე მოვაჭრეები ცდილობდნენ ეპოვათ გამოსავალი, რათა დღის განმავლობაში შეძლებოდათ
    მგზავრებისთვის სხვადასხვა სახეობის პროდუქტი შეეთავაზებინათ: <strong>საღეჭი რეზინები, საწერი კალმები, ელემენტები, დუბაის პარკები, ფანრები, კბილის ჯაგრისები, 
    ერთჯერადი შამპუნები საეკლესიო კალენდრები და ა.შ.</strong> საღამოს საათებში, მეტროში პოტენციური მომხმარებლების რაოდენობა იკლებდა. ამ დროს, მეტროთი, როგორც ჩანს, 
    ძირითადად "მთვრალები, კახპები და უკიდურესად გაჭირვებულები მგზავრობდნენ და ისინი რაიმეს შეძენას არ აპირებდნენ." ხელზე მოვაჭრეები, ყოველდღიურად, საკუთარი მონაგარიდან, 
    2 ლარამდე, მეტროს 'სპეცებს' - დაცვის სამსახურის წარმომადგენლებს - უტოვებდნენ. მათი ოფიციალური ანაზღაურება თვეში 70 ლარს შეადგენდა. მათგან განსხვავებით, ხელზე მოვაჭრეები, 
    თვიურად, უფრო მეტს გამოიმუშავედნენ - დღეში მათი მოგება 6-10 ლარის ფარგლებში მერყეობდა.
    სანაცვლოდ, 'სპეცები', მათ ვაჭრობაში ხელს არ უშლიდნენ. უფრო მეტიც, ისინი მოვაჭრეებთან თანამშრომლობდნენ კიდეც და მეტროში "ახალი სახეების" აღმოჩენაში ეხმარებოდნენ. 
    გარდა ამისა, მოვაჭრეები, სამ ზონად იყოფდნენ მეტროს პირველ ხაზს და ერთმანეთს, რიგ-რიგობით ენაცვლებოდნენ ორივე მიმართულებით. შემდეგ კი, რიგში მყოფ მომდევნო მოვაჭრეს 
    უთმობდნენ მატარებლის ვაგონებს.
    <br>თბილისის მეტროში არსებული სოციო-სივრცითი და დროითი კავშირები, ინფრასტრუქტურა, არაფორმალური გარიგებები და წვრილმანი კორუფცია ქმნიდა <strong>ურბანული მობილობის ინფრასტრუქტურის პოსტსოციალისტურ ჰიბრიდს.</strong>`, 
    category: "article", image: '/Users/giorgikankia/Documents/GitHub/The-History-of-Urban-Mobility-Governance-in-Tbilisi/img/metro vendors.png', 
    source: {
  ...
  { date: "2004-02-03", title: "ტრანსპორტისა და კავშირგაბმულობის სამინისტრო", 
    description: `სახელმწიფო კანცელარიაში დააკავეს მინისტრი მერაბ ადეიშვილი. მას <strong>ძალაუფლების გადამეტებასა და სახელმწიფო სახსრების მითვისებაში</strong> ედებოდა ბრალი. 
